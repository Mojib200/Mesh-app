                                ...
                                <div class="auth-form">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn bg-white text-primary btn-block">Log
                                                in</button>
                                        </div>
                                    </form>
                                    <div class="new-account mt-3">
                                        <p class="text-white">Don't have an account? <a class="text-white"href="{{route('register')}}"><u>Register</u></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
